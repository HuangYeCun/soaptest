...
#ifndef soaptestService_H
#define soaptestService_H
#include "soapH.h"

    class SOAP_CMAC testService : public soap {
      public:
        ...
        testService(const struct soap&);
        /// Construct service given a managing context and endpoint
        testService(const struct soap&, const char *soap_endpoint_url);
        /// Constructor taking input+output mode flags for the new managing context
        testService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        testService(soap_mode imode, soap_mode omode);
        ...
        virtual void testService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual testService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        ...
        //
        /// Web service operation 'test' implementation, should return SOAP_OK or error code
        virtual int test(std::string &response) SOAP_PURE_VIRTUAL;
    };
#endif
